...
__all__ = ('TemporalAttachmentLDDMMGeomPeriodic', 'RegularityLDDMMPeriodic')



class TemporalAttachmentLDDMMGeomPeriodic(Functional):
    ...
    def __init__(self, T,nb_time_point_int, template, data, data_time_points, forward_operators,Norm, kernel, domain=None):
        """
        Parameters
        ----------
