...
__all__ = ('steepest_descentbis',)


# TODO: update all docs


def steepest_descentbis(f, x, line_search=1.0, maxiter=1000, tol=1e-16,
    ...
    for it in range(maxiter):
        ...
        val=f(x)
        print('Iteration {}  Energy {}'.format(it,val))
...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb  2 15:21:40 2017
