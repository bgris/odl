...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan  5 11:19:10 2018
...
path_figure = '/home/' + namepath + '/Dropbox/Recherche/presentations/CambridgeDec2017/figures/'
...
for name in name_list:
    image = space.element(np.loadtxt(path_result + name + '_t_' + str(time_itvs)))
