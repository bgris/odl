...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 11 15:33:07 2017
...
path_data = '/home/' + nom_path + '/Dropbox/Recherche/mes_publi/Metamorphosis_PDE_ODE/data/test1/'
path_result_init = '/home/' + nom_path + '/Results/Metamorphosis/test1Sobolev/'
path_result = path_result_init + name_exp + '__sigma_' + name_sigma + '__mu_' + name_mu + '__lamb_'
path_result += name_lamb + '__tau_' + name_tau + '__niter_' + str(niter) + '__ntimepoints_' + str(time_itvs) + '/'

path_result_init_dropbox = '/home/' + nom_path + '/Dropbox/Recherche/mes_publi/Metamorphosis_PDE_ODE/Results_ODE/test1Sobolev/'
path_result_dropbox = path_result_init_dropbox + name_exp + '__sigma_' + name_sigma + '__mu_' + name_mu + '__lamb_'
...
if smooth:
    ...
    template = rec_space.element(ndimage.gaussian_filter(template, 3))
