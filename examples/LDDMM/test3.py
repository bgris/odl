...
for k in range(niter):
    ...
    vector_fields_list_tmp= (vector_fields_list- eps *grad).copy()
    attachment_term_tmp=energy_op(vector_fields_list_tmp)
    if (attachment_term_tmp < attachment_term):
        attachment_term = attachment_term_tmp
        vector_fields_list = copy.deepcopy(vector_fields_list_tmp)
        print(" iter : {}  ,  attachment term : {}".format(k,attachment_term))
        eps *= 1.2
        #vector_fields_list[0].show(k)
    else:
        eps *= 0.8
        print(" iter : {}  ,  attachment term : {}, eps = {}".format(k,attachment_term, eps))
#    print(" iter : {}  ,  attachment term : {}".format(k,attachment_term))
#
...
#maxi = 1
#
#name = '/home/bgris/Results/DeformationModule/test0/' + 'angles_' + str(num_angles) + '_LDDMM_sigma_' +str(int(sigma))
#image = np.rot90(image_N0[-1])
...
## -*- coding: utf-8 -*-
#"""
#Created on Thu Feb 15 16:55:59 2018
#
#@author: bgris
#"""
#
