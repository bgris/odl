...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 11 17:23:46 2017
...
mu = 1e-1
name_mu='1e_' + str(-int(np.log(mu)/np.log(10)))
lamb = 1e-5
...
path_data = '/home/' + nom_path + '/Dropbox/Recherche/mes_publi/Metamorphosis_PDE_ODE/data/test2/'
path_result_init = '/home/' + nom_path + '/Results/Metamorphosis/test2Sobolev/'
#path_result_init = '/home/' + nom_path + '/Dropbox/Recherche/mes_publi/Metamorphosis_PDE_ODE/Results/test2/'
path_result = path_result_init + name_exp + name_reg +'__sigma_' + name_sigma +  '__mu_' + name_mu + '__lamb_'
path_result += name_lamb + '__tau_' + name_tau + '__niter_' + str(niter) + '__ntimepoints_' + str(time_itvs) + '/'



path_result_init_dropbox = '/home/' + nom_path + '/Dropbox/Recherche/mes_publi/Metamorphosis_PDE_ODE/Results_ODE/test2Sobolev/'
path_result_dropbox = path_result_init_dropbox + name_exp + name_reg + '__sigma_' + name_sigma + '__mu_' + name_mu + '__lamb_'
...
functional=odl.deform.TemporalAttachmentMetamorphosisGeomSobolev(nb_time_point_int,
                            mu, lamb,tau,template ,data,
